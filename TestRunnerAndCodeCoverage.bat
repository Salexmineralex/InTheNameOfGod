...
C:\OpenCppCoverage64\OpenCppCoverage\OpenCppCoverage.exe --sources=\Source --modules=F:\UE_5.1\Engine\Plugins\Bridge\Binaries\Win64 --excluded_sources=\Tests --export_type=cobertura:%codeCoverageFile% --working_dir=F:\CITestingWorkspace\ -- %testRunnerCommand%
