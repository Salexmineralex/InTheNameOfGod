...
"F:\OpenCppCoverage\OpenCppCoverage.exe" --sources=%workspace%\Source --modules %workspace% --excluded_sources=\Tests --working_dir=%workspace% --export_type=cobertura:%codeCoverageFile%  -- %testRunnerCommand%
