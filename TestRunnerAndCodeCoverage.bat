...
F:\UE_5.1\Engine\Binaries\Win64\UnrealEditor-Cmd.exe "F:\CITestingWorkspace\InTheNameOfGod.uproject" -unattended -nopause -NullRHI -ExecCmds="Automation RunTests" -testexit="Automation Test Queue Empty" -log -log=RunTests.log -ReportOutputPath=%testReportFolder%
