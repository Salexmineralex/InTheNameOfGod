...
C:\OpenCppCoverage\OpenCppCoverage.exe --sources=\Source --modules %workspace% --excluded_sources=\Tests --export_type=cobertura:%codeCoverageFile% --working_dir=--config_file  -- %testRunnerCommand%
